...
const logUploadFile = (num, color="green") => {
...
const useApp = () => {
	...
	//sets the next file when it senses that it is ready to go. 
	useEffect (() => {
	...
	//Processing the next pending thumbnail when ready 
	useEffect (() => {
